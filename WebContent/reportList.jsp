...
<body>
    ...
    <div class="container" > 
		...
		<div class="panel-heading">
         ...
         <div class="col-sm-12 commonDiv" id="otpDiv" style="display:none;">
             <div class="row">
               <div class="col-sm-4">
               </div>
               <div class="col-sm-4">
                    <label>Enter OTP Here  </label>
                    <input type="hidden" class="form-control" id="sentOtp" /><br>
             		<input type="text" class="form-control" id="otp" /><br>
             ...
             <div class="row" style="margin-top: 10px;">
               ...
               <div class="col-sm-2">
                    <button type="button" class="btn btn-default" onclick="closeOtpDiv();">Back</button>
               </div>
               <div class="col-sm-2">
                    <button type="button" onclick="downloadFile()" class="btn btn-success">Download</button>
               </div>
             </div>
          ...
          <div class="col-sm-12 commonDiv" id="listDiv">
             ...
             <div style="margin-bottom: 8px;">
               <a href="PatientMasterServlet?action=GetAllList" ><button type="button" class="btn btn-primary">Back to patients</button></a>
             </div>
             
          
             <table id="reportList" class="table table-bordered table-striped hover">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Report name</th>
                 ...
                 <td>${patientReport.reportFileName}</td>
                  ...
                  <c:if test="${user.role=='Patient'}">
                   <td><a  href="DownloadFile?id=${patientReport.id}" >Download</a></td>
                    ...
                    <td><a  href="PatientReportServlet?reportId=${patientReport.id}">delete</a> </td>
                  </c:if>
...
function sendOtp(){
	$.ajax({
		url:"${pageContext.request.contextPath}/PatientHistoryAndReportsServlet?action=sendOtp",
		method:"get",
...
function openOtpModal(reportId){
