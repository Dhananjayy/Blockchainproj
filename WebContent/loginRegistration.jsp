...
<body>
    ...
    <!-- login block -->
        ...
        <div class="login-box" id="logBox">
		    ...
		    <a onclick="toggle(2);" style="text-decoration:none;cursor: pointer;" class="text-center">I forgot my password</a><br>
	    	<!-- <a onclick="toggle(0);" style="text-decoration:none;cursor: pointer;" class="text-center">Register a new membership</a> -->
           </div>
        </div>
        
       <!-- Forget password block --> 
        <div class="login-box" id="forgetPassBox" style="display:none;" >
	  		 <div class="login-box-body">
		    	...
		    	<form action="RegistrationServlet" method="post">
			      ...
			      <div class="row" style="margin-bottom: 10px;">
			        <!-- /.col -->
			        <div class="col-xs-4">
			          <button type="button" onclick="sendPasswordMail(this);" class="btn btn-primary btn-block btn-flat">Submit</button>
			        </div>
			        <!-- /.col -->
			      </div>
		    </form>
		    
	    	<a onclick="toggle(1);" style="text-decoration:none;cursor: pointer;" class="text-center">Back</a>
           </div>
        </div>
        ...
        <div class="login-box" style="display:none;" id="regBox">
	  		 <div class="login-box-body">
		    	...
		    	<form action="RegistrationServlet" method="post">
				      ...
				      <input  type="hidden" name="address" class="form-control" placeholder="City" required>
				      <div class="form-group has-feedback">
				      ...
				      <div class="row" style="margin-bottom: 10px;">
				        <!-- /.col -->
				        <div class="col-xs-4">
				          <button type="submit" name="action" value="signUp" class="btn btn-primary btn-block btn-flat">Register</button>
				        </div>
				        <!-- /.col -->
				      </div>
		    </form>
...
function sendPasswordMail(obj){
	 ...
	 $(obj).attr('disabled',true);
	  ...
	  $.ajax({
		  ...
		  data:{action:"forgetPass",emailAddress:emailAddress},	  
		  type:'get',
