			...
			if(login!=null)
			{
				...
				//	session.removeAttribute("id");
					...
					if(login.getRole().equals("Patient")){
						PatientMaster patientMaster  =new PatientMasterDaoImpl().getElementByUserId((int)login.getId());
						login.setPatientId(patientMaster.getId());
					}
					session.setAttribute("user", login);
					String redirectPage = login.getRole().equals("Admin")?"adminHome.jsp":login.getRole().equals("Doctor")?"doctorHome.jsp":"patientHome.jsp";
