...
public class ImageUploadServlet1 extends HttpServlet {
	...
	////	String fileNumSessionValueForStallDesign = request.getParameter("fileNumSessionValueForStallDesign");
	//	System.out.println("fileNumSessionValueForStallDesign in get :::::::::: "+fileNumSessionValueForStallDesign);
                    ...
                    if (!item.isFormField()) {
                     ...
                     //   String root = getServletContext().getRealPath("/");
                        ...
                        /*ImageUploadInterface ImageUploadInf=new ImageUploadImpl();
    	    			 ...
    	    			 System.out.println("IMAGEUPLOADDD");
    	    			 //long file_id=ImageUploadInf.savepath(imageUploadObj,);
                     
    	    			  String originalFilePath=absoluteFilePath+"\\"+fileName;
    	    			  File checkFile=new File(originalFilePath);
    	    			  String savedFiles="";
    	    			  long fileSize=checkFile.length();
    						...
    						if(fileName.endsWith("txt") ||  fileName.endsWith("TXT"))
    						{
        	    			  ...
        	    			  System.out.println("lines"+lines);
        	    			   	...
        	    			   	if(lines<=5)
        	    			   	{
        	    			   		savedFiles=absoluteFilePath+"\\Folder1";
        	    			   	}else{
    						...
    						SplittFile.splitFile(absoluteFilePath,originalFilePath,savedFiles,uname,file_id);*/
    						}
