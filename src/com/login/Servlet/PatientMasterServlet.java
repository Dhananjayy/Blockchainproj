...
public class PatientMasterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			patientMaster =  getElementById(request, session, patientMaster,
					patientMasterInterface);
		...
		else if(action!=null && action.equals("viewMyHistory"))
		{
			...
			List<PatientHistory> patientHistories = new PatientHistoryDaoImpl().getAllbyPatientId(patientMaster.getId());
	...
	private PatientMaster getElementById(HttpServletRequest request,
			HttpSession session, PatientMaster patientMaster,
	 ...
	 * @throws IOException
	 */
	private List<PatientMaster> getAllPatientList(HttpServletResponse response,
			HttpSession session, PatientMasterInterface patientMasterInterface)
			throws IOException {
